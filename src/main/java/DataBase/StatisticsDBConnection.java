...
import com.mycompany.spprfull.BDConnection;
import com.mycompany.spprfull.DataOutput;

/**
 *
 * @author Da-pro
 */
public class StatisticsDBConnection implements BDConnection, DataOutput {

    @Override
    public void getDBConnection(int idDB) {
